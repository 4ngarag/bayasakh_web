    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-ends m-2 p-2">
                <a href="{{ route('admin.companies.create') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Нэмэх</a>
            </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                {{ Str::limit(strip_tags($company->intro_mn), 50) }}
                            </td>
                            <td class="px-6 py-4">
                                <img src="{{ Storage::url($company->logo_mn) }}" class="w-32 rounded">
                            </td>
