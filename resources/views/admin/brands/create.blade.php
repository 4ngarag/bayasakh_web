    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-ends m-2 p-2">
                <a href="{{ route('admin.brands.index') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Буцах</a>
            </div>
            ...
            <form method="POST" action="{{ route('admin.brands.store') }}" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label for="name" class="block text-sm font-medium text-gray-700">Брэнд нэр</label>
                        <div class="mt-1">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        <label for="companies" class="block text-sm font-medium text-gray-700"> Компани </label>
                        <div class="mt-1">
