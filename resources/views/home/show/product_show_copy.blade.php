...
<section class="relative table w-full py-32 lg:py-40 bg-no-repeat bg-center bg-cover" style="background-image: url('{{ Storage::url($product->brand->slider_image) }}') !important;">
    ...
    <div class="container relative">
        <div class="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <ul class="list-none">
                <li class="inline font-semibold text-white/60 me-2"> <span class="text-white">Брэнд :</span> ...</li>
    ...
    <div class="container relative">
        <div class="grid grid-cols-1">
            <div class="tiny-single-item">
                ...
                <div class="tiny-slide">
                    <div class="m-2">
                        <img src="{{ Storage::url($product->logo) }}" class="rounded-md shadow dark:shadow-gray-800" alt="">
                    </div>
                </div>
                <div class="tiny-slide">
                    <div class="m-2">
    ...
    <div class="container relative md:mt-24 mt-16">
        <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
            ...
            <div class="lg:col-span-8 md:col-span-7">
                <div class="lg:me-5">
                    <h4 class="text-xl font-semibold mb-3 border-b border-gray-100 dark:border-gray-700 pb-3">Бүтээгдэхүүний танилцуулга :</h4>
